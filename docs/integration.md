...
The platform must also provide a way for users to recover their passphrase if they have forgotten the current one. This information comes through the [hint link](https://readium.org/lcp-specs/releases/lcp/latest#link-relationships) present in every LCP license generated by the LCP Server. 
